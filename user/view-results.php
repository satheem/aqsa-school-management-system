...
// Get the Student ID from the session and the URL parameter
$loggedInStuID = $_SESSION['sturecmsstuid'];
$viewID = isset($_GET['viewid']) ? $_GET['viewid'] : '';

// If the logged-in student's ID does not match the view ID, show a warning and redirect
if ($loggedInStuID !== $viewID) {
    echo "<script>alert('You are not authorized to view this student\'s information. Redirecting to your dashboard.');</script>";
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">View Results
                                </li>
                            </ol>
                        </nav>
                    </div>
                    <div class="view-container">
                        <div class="view-wrapper">
                            <h4 class="view-title">Results</h4>
