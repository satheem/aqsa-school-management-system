...
if (isset($_POST['login'])) {
    ...
    if ($query->rowCount() > 0) {
        ...
        // Redirect to dashboard with the first student's ID in the result set
        echo "<script type='text/javascript'> document.location = 'dashboard.php?viewid=" . htmlentities($result->StuID) . "'; </script>";
    } else {
