...
{             {
    // Fetch the student data based on the logged-in student's ID
...
?>
            ...
            <li class="nav-item">
    <a class="nav-link" href="dashboard.php?viewid=<?php echo htmlentities($student->StuID); ?>">
        <span class="menu-title">Dashboard</span>
        <i class="icon-screen-desktop menu-icon"></i>
    </a>
</li>
<li class="nav-item">
<a class="nav-link" href="view-results.php?viewid=<?php echo htmlentities($student->StuID); ?>">
