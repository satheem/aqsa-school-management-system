...
if (isset($_GET['id'])) {
    ...
    // Prepare and execute the SQL query to fetch staff details
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Handle file upload
    $photo = $staff['photo']; // Use existing photo as default
    ...
    // Prepare and execute the SQL query to update staff details
    $sql = "UPDATE tblstaff 
    ...
    if ($query->execute()) {
        ...
        echo "<script>alert('Error updating staff details: " . htmlspecialchars($errorInfo[2]) . "');</script>";
    }
}
?>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="form-container">
                        <div class="form-wrapper">
                            <h4 class="form-title">Edit Staff</h4>
                            <form method="post" action="" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="staffID">Staff ID</label>
                                    <input type="text" class="form-control" id="staffID" name="staffID" value="<?php echo htmlspecialchars($staff['StaffID']); ?>" >
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="first_appointment" name="first_appointment" value="<?php echo htmlspecialchars($staff['first_appointment']); ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="appointed_this_school">Appointed This School</label>
                                    <input type="text" class="form-control" id="appointed_this_school" name="appointed_this_school" value="<?php echo htmlspecialchars($staff['appointed_this_school']); ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="appointment_subject">Appointment Subject</label>
                                    <input type="text" class="form-control" id="appointment_subject" name="appointment_subject" value="<?php echo htmlspecialchars($staff['appointment_subject']); ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="edu_qualify">Educational Qualification</label>
                                    <input type="text" class="form-control" id="edu_qualify" name="edu_qualify" value="<?php echo htmlspecialchars($staff['edu_qualify']); ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="prof_qualify">Professional Qualification</label>
                                    <input type="text" class="form-control" id="prof_qualify" name="prof_qualify" value="<?php echo htmlspecialchars($staff['prof_qualify']); ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="service_grade">Service Grade</label>
                                    <input type="text" class="form-control" id="service_grade" name="service_grade" value="<?php echo htmlspecialchars($staff['service_grade']); ?>" required>
                                </div>
                                <div class="form-group">
