  ...
  <ul class="nav">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="auth1">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="add-news.php"> Add News </a></li>
          <li class="nav-item"> <a class="nav-link" href="manage-news.php"> Manage News </a></li>
          <li class="nav-item"> <a class="nav-link" href="add-news-banner.php"> Add News Banner</a></li>
          <li class="nav-item"> <a class="nav-link" href="manage-banner.php"> Manage Banner</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
