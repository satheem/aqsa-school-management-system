...
// Fetch existing news data from the database
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Prepare and execute the SQL query to update news in the database
    $sql = "UPDATE tblnews SET Title = :title, Content = :content, Image = :image WHERE id = :id";
    $query = $dbh->prepare($sql);
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="dashboard.php">Manage News</a></li>
                    ...
                    <div class="form-container">
                        <div class="form-wrapper">
                            <h4 class="form-title">Edit News</h4>
                            <form method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="./uploads/<?php echo htmlspecialchars($news['Image']); ?>" alt="Current Image">
                                </div>
