...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Prepare and execute the SQL query to insert teacher into the database
    $sql = "INSERT INTO tblteachers (TeacherID, full_name, gender, first_appointment, appointed_this_school, appointment_subject, edu_qualify, prof_qualify, service_grade, email, photo) 
            VALUES (:teacherID, :full_name, :gender, :first_appointment, :appointed_this_school, :appointment_subject, :edu_qualify, :prof_qualify, :service_grade, :email, :photo)";
                ...
                <div class="content-wrapper">
                    ...
                    <div class="form-container">
                        <div class="form-wrapper">
                            <h4 class="form-title">Add Teacher</h4>
