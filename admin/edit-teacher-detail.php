...
// Fetch teacher details if ID is provided
if (isset($_GET['id'])) {
    $teacherID = $_GET['id'];

    // Prepare and execute the SQL query to fetch teacher details
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Handle file upload
    $photo = $teacher['photo']; // Use existing photo as default
    ...
    // Prepare and execute the SQL query to update teacher details
    $sql = "UPDATE tblteachers 
            SET full_name = :full_name, gender = :gender, first_appointment = :first_appointment, 
                appointed_this_school = :appointed_this_school, appointment_subject = :appointment_subject, 
                edu_qualify = :edu_qualify, prof_qualify = :prof_qualify, service_grade = :service_grade, 
                ...
                <div class="content-wrapper">
                    ...
                    <div class="form-container">
                        <div class="form-wrapper">
                            <h4 class="form-title">Edit Teacher</h4>
                            <form method="post" action="" enctype="multipart/form-data">
                                
                                <div class="form-group">
                                    <label for="full_name">Teacher ID</label>
                                    <input  name="teacherID" class="form-control" id="eacherid" value="<?php echo htmlspecialchars($teacher['TeacherID']); ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="first_appointment" name="first_appointment" value="<?php echo htmlspecialchars($teacher['first_appointment']); ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="appointed_this_school">Appointed This School</label>
                                    <input type="text" class="form-control" id="appointed_this_school" name="appointed_this_school" value="<?php echo htmlspecialchars($teacher['appointed_this_school']); ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="appointment_subject">Appointment Subject</label>
                                    <input type="text" class="form-control" id="appointment_subject" name="appointment_subject" value="<?php echo htmlspecialchars($teacher['appointment_subject']); ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="edu_qualify">Educational Qualification</label>
                                    <input type="text" class="form-control" id="edu_qualify" name="edu_qualify" value="<?php echo htmlspecialchars($teacher['edu_qualify']); ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="prof_qualify">Professional Qualification</label>
                                    <input type="text" class="form-control" id="prof_qualify" name="prof_qualify" value="<?php echo htmlspecialchars($teacher['prof_qualify']); ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="service_grade">Service Grade</label>
                                    <input type="text" class="form-control" id="service_grade" name="service_grade" value="<?php echo htmlspecialchars($teacher['service_grade']); ?>" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="./uploads/<?php echo htmlspecialchars($teacher['photo']); ?>" alt="Teacher Photo" style="width: 150px; height: auto; margin-top: 10px;">
                                </div>
