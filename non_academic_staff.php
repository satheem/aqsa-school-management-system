...
$sql_total = "SELECT COUNT(*) as total FROM tblstaff WHERE full_name LIKE '%$search%' OR appointment_subject LIKE '%$search%' OR edu_qualify LIKE '%$search%' OR prof_qualify LIKE '%$search%'";
$result_total = $conn->query($sql_total);
$total = $result_total->fetch_assoc()['total'];
$pages = ceil($total / $limit);

// Fetch non-academic staff data
$sql = "SELECT * FROM tblstaff WHERE full_name LIKE '%$search%' OR appointment_subject LIKE '%$search%' OR edu_qualify LIKE '%$search%' OR prof_qualify LIKE '%$search%' LIMIT $start, $limit";
...
<head>
    ...
    <title>Non-Academic Staff - THE AL AQSA SCHOOL</title>
    ...
    <header>
        ...
        <div class="side-navbar">
            ...
            <ul class="side-nav-link">
                ...
                <li><a href="astaffs.php">ACADEMIC STAFF</a></li>
                <li><a href="non_academic_staff.php">NON-ACADEMIC STAFF</a></li>
        ...
        <?php if ($result->num_rows > 0): ?>
            <?php while ($row = $result->fetch_assoc()): ?>
                <div class="staff-item">
                    <img src="admin/uploads/<?php echo htmlspecialchars($row['photo']); ?>" alt="Staff Image">
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p>No non-academic staff found.</p>
        <?php endif; ?>
